    ...
    Tables: {
      ...
      site_settings: {
        Row: {
          ...
          about_header_image_url: string | null
          ...
          hero_food_images: Json
          hero_image_mobile_url: string | null
          hero_image_url: string | null
          hero_overlay_images: Json
          hero_subtitle: string
          hero_tagline: string
          hero_title: string
          hero_title_lines: Json
          how_we_cook: Json
          how_we_cook_header_image_url: string | null
          id: string
          instagram_url: string | null
          locations_header_image_url: string | null
